...
public final class DrawNumberControllerImpl implements DrawNumberController {
    ...
    private ArrayList<DrawNumberView> view;
    ...
    public void newAttempt(final int n) {
        for (DrawNumberView singleView : view) {
            Objects.requireNonNull(singleView, "There is no view attached!").result(model.attempt(n));
        }
    }
